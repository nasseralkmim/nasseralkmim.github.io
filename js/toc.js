...
window.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById("toc")) {
        ...
        const activateLast = () => {
            document.querySelectorAll('#toc li.active, #toc ul.active').forEach(a => {
            ...
            activate(document.querySelector(`#toc li a[href="#${mostRecent.section.getAttribute('id')}"]`).parentElement);
        }
